...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/eigen-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/eigen-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add eigen eigen-abi eigen-abi-devel
# for installing globally
pixi global install eigen eigen-abi eigen-abi-devel
```
...
It is possible to list all of the versions of `eigen` available on your platform:
...
```
pixi search eigen --channel conda-forge
```
